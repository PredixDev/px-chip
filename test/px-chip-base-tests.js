...
function runBaseTests() {
  px_chip_1 = document.getElementById('px_chip_1');

  suite('Base Automation Tests for px-chip', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('px-chip fixture is created', function() {
      assert.isTrue(document.getElementById('px_chip_1') !== null);
    });
